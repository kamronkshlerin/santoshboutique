...
export const TrustBar: React.FC = () => {
  return (
    <section className="relative py-8 bg-[#18050a] border-y border-[#f3cf98]/15 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-wrap items-center justify-between gap-6 sm:gap-8">
          {/* Quote Pill from Flyer */}
          <div className="flex items-center gap-3 liquid-glass px-4 py-2.5 rounded-2xl border border-[#f3cf98]/20">
            <span className="text-2xl">❝</span>
            <div>
              <p className="font-display italic text-sm sm:text-base text-[#f3cf98]">
                Beautiful Outfits, Happier You
              </p>
              <p className="text-[11px] text-[#d1b8b8] tracking-wider uppercase">
