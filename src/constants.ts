...
export const REAL_ASSETS = {
  ...
  blogExpressFitting: `${CDN_BASE}/images/blog_express_fitting.jpg`,
  blogMandiFestive: `${CDN_BASE}/images/blog_mandi_festive.jpg`,
  blogHamirpurSharara: `${CDN_BASE}/images/blog_hamirpur_sharara.jpg`,
  blogKangraBridal: `${CDN_BASE}/images/blog_kangra_bridal.jpg`,
  blogVelvetWinterSuit: `${CDN_BASE}/images/blog_velvet_winter_suit.jpg`,
  blogSolanFusion: `${CDN_BASE}/images/blog_solan_fusion.jpg`,
  blogHimachaliPattu: `${CDN_BASE}/images/blog_himachali_pattu.jpg`,
  blogUnaSuit: `${CDN_BASE}/images/blog_una_suit.jpg`,
  blogChambaSilk: `${CDN_BASE}/images/blog_chamba_silk.jpg`,
  blogSirmaurLehenga: `${CDN_BASE}/images/blog_sirmaur_lehenga.jpg`,
  blogPashminaWarm: `${CDN_BASE}/images/blog_pashmina_warm.jpg`,
  blogBlousesCouture: `${CDN_BASE}/images/blog_blouses_couture.jpg`,
  blogExpressAlteration: `${CDN_BASE}/images/blog_express_alteration.jpg`,
  blogPinterestRecreation: `${CDN_BASE}/images/blog_pinterest_recreation.jpg`,
  blogPlussizeElegance: `${CDN_BASE}/images/blog_plussize_elegance.jpg`,
  blogFabricsSelection: `${CDN_BASE}/images/blog_fabrics_selection.jpg`,
  blogAnarkaliFlare: `${CDN_BASE}/images/blog_anarkali_flare.jpg`,
  blogNeckSleeves: `${CDN_BASE}/images/blog_neck_sleeves.jpg`,
  blogOnlineBooking: `${CDN_BASE}/images/blog_online_booking.jpg`,
